					...
					<form class="form-ad">
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label class="control-label" for="textarea">Per Hour</label>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="divider"><h3>SSLC</h3></div>
							</div>
							<div class="col-md-6">
								<div class="divider"><h3>HSE(+2)</h3></div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<input type="text" class="form-control" placeholder="e.g 65%">
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="divider"><h3>Diploma</h3></div>
							</div>
							<div class="col-md-4">
								<div class="divider"><h3>UG</h3></div>
							</div>
							<div class="col-md-4">
								<div class="divider"><h3>PG</h3></div>
							</div>
						</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="widget">
						<h3 class="block-title"><img src="data:image/webp;base64," class="img-responsive" alt="Footer Logo" data-pagespeed-url-hash="1699701835" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></h3>
...
<script type="text/javascript" src="{{url('public/website/assets/js/jquery-min.js')}}"></script>      
<script type="text/javascript" src="{{url('public/website/assets/js/bootstrap.min.js')}}"></script>    
<script type="text/javascript" src="{{url('public/website/assets/js/material.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/material-kit.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/jquery.parallax.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/owl.carousel.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/jquery.slicknav.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/main.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/jquery.counterup.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/waypoints.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/jasny-bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/bootstrap-select.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/form-validator.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/website/assets/js/contact-form-script.js')}}"></script>  
